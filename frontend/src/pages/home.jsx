          ...
          <Row>
            <Col lg='6'>
              <div className="hero__content">
                ...
                <h1>
                  Du lịch là cách để tâm hồn được tự do và trái tim được rộng mở. <span className="highlight">Memories</span>
                </h1>
                <p>
...
<section>
    ...
    <Row>
      <Col lg="6">
        <div className="experience_content">
          ...
          <h2>
          Bằng tất cả kinh nghiệm dày dặn, chúng tôi cam kết mang đến dịch vụ tận tâm và chuyên nghiệp nhất. <br />
          </h2>
  ...
  <div className="counter_box">
    ...
    <h6>Years experience</h6>
      ...
      <Col lg="6"> <div className="experience__img">
...
<Container>
        <Row>
           ...
           <Col lg='12'>
              <Subtitle subtitle={'Bộ sưu tập ảnh' } />
              <h2 className="gallery__title">Khám phá những khoảnh khắc đáng nhớ trong hành trình của khách hàng đã tin tưởng lựa chọn chúng tôi.</h2>
           </Col>
        <Col lg ='12'> 
...
<       Container>  
              ...
              <Col lg='12'>  <Subtitle subtitle={'Fans Yêu Thích'}/>
